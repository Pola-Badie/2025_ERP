...
const CustomerSelector = ({ customers, orders, selectedCustomer, searchTerm, isOpen, onCustomerSelect, onSearchChange, onOpenChange, placeholder = "Select customer...", label = "Customer" }) => {
    ...
    return (<div>
      ...
      <Popover open={isOpen} onOpenChange={onOpenChange}>
        ...
        <PopoverContent className="w-full p-0">
          <Command>
            <CommandInput placeholder="Search customers..." value={searchTerm} onValueChange={onSearchChange}/>
            <CommandList>
                ...
                onOpenChange(false);
                    ...
                    <div className="flex flex-col w-full">
                      <div className="flex items-center justify-between">
                        ...
                        {customer.orderCount > 0 && (<Badge variant="outline" className="text-xs">
                      ...
                      {customer.lastOrderProduct && (<div className="text-xs text-muted-foreground mt-1">
                          Last: {customer.lastOrderProduct} • ${customer.lastOrderValue}
                          {customer.lastOrderDate && (<span className="ml-2">
      ...
      {selectedCustomer && (<div className="mt-2 p-3 bg-muted rounded-md">
          ...
          {selectedCustomer.orderCount > 0 && (<div className="text-xs text-muted-foreground mt-1">
              Previous orders: {selectedCustomer.orderCount}
              {selectedCustomer.lastOrderDate && (<span className="ml-2">
