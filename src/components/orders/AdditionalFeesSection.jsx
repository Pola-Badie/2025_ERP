...
const AdditionalFeesSection = ({ additionalFees, setAdditionalFees }) => {
      ...
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          <div>
            ...
            <Input id="feeLabel" placeholder="e.g., Labor, Energy, Packaging" value={feeLabel} onChange={(e) => setFeeLabel(e.target.value)}/>
          </div>
          <div>
            <Label htmlFor="feeAmount">Amount</Label>
            <Input id="feeAmount" type="number" min="0" step="0.01" placeholder="Amount" value={feeAmount} onChange={(e) => setFeeAmount(e.target.value)}/>
          </div>
        ...
        <div>
          <Table>
            ...
            <TableBody>
              {additionalFees.length === 0 ? (<TableRow>
                  <TableCell colSpan={3} className="text-center py-4">
                    No additional fees added
                  </TableCell>
                </TableRow>) : (additionalFees.map((fee, index) => (<TableRow key={index}>
