...
const EditCustomerDialog = ({ open, onOpenChange, customer, onSave }) => {
          ...
          <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-2">
                ...
                <Input id="name" name="name" placeholder="Full customer name" value={editedCustomer.name || ''} onChange={handleInputChange} className={`border-blue-200 focus:ring-blue-500 ${formErrors.name ? "border-red-500" : ""}`}/>
                {formErrors.name && (<p className="text-sm text-red-500">{formErrors.name}</p>)}
              </div>
              
              <div className="space-y-2">
                <Label htmlFor="position" className="text-blue-700 font-medium">Position/Title</Label>
                <Input id="position" name="position" placeholder="Job title or position" value={editedCustomer.position || ''} onChange={handleInputChange} className="border-blue-200 focus:ring-blue-500"/>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
              ...
              <div className="space-y-2">
                ...
                <Input type="date" className="border-blue-200 focus:ring-blue-500" defaultValue="2024-01-15"/>
              </div>
            </div>
          </div>
          ...
          <div className="bg-green-50 p-4 rounded-lg border border-green-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input id="company" name="company" placeholder="Full company name" value={editedCustomer.company || ''} onChange={handleInputChange} className={`border-green-200 focus:ring-green-500 ${formErrors.company ? "border-red-500" : ""}`}/>
              ...
              <div className="space-y-2">
                ...
                <Select value={editedCustomer.sector} onValueChange={handleSectorChange}>
                  <SelectTrigger className="border-green-200 focus:ring-green-500">
                    <SelectValue placeholder="Select industry sector"/>
                  </SelectTrigger>
                  <SelectContent>
                    <SelectGroup>
                      {industrySectors.map((sector) => (<SelectItem key={sector} value={sector}>
                          {sector}
                        </SelectItem>))}
                    </SelectGroup>
                  </SelectContent>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
              ...
              <div className="space-y-2">
                ...
                <Input placeholder="Company registration number" className="border-green-200 focus:ring-green-500"/>
              </div>
            </div>
          </div>
          ...
          <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input id="email" name="email" type="email" placeholder="customer@company.com" value={editedCustomer.email || ''} onChange={handleInputChange} className={`border-purple-200 focus:ring-purple-500 ${formErrors.email ? "border-red-500" : ""}`}/>
                {formErrors.email && (<p className="text-sm text-red-500">{formErrors.email}</p>)}
              </div>
              
              <div className="space-y-2">
                <Label htmlFor="phone" className="text-purple-700 font-medium">Phone Number *</Label>
                <Input id="phone" name="phone" placeholder="+20 2 1234 5678" value={editedCustomer.phone || ''} onChange={handleInputChange} className={`border-purple-200 focus:ring-purple-500 ${formErrors.phone ? "border-red-500" : ""}`}/>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
              <div className="space-y-2">
                ...
                <Input placeholder="Emergency or alternative contact" className="border-purple-200 focus:ring-purple-500"/>
              </div>
          ...
          <div className="bg-orange-50 p-4 rounded-lg border border-orange-200">
            ...
            <div className="grid grid-cols-1 gap-4">
              <div className="space-y-2">
                ...
                <Textarea id="address" name="address" placeholder="Complete business address" value={editedCustomer.address || ''} onChange={handleInputChange} className="min-h-[100px] border-orange-200 focus:ring-orange-500"/>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
              <div className="space-y-2">
                ...
                <Input placeholder="City name" className="border-orange-200 focus:ring-orange-500"/>
              </div>
              
              <div className="space-y-2">
                <label className="text-sm font-medium text-orange-700">State/Province</label>
                <Input placeholder="State or province" className="border-orange-200 focus:ring-orange-500"/>
              </div>
          ...
          <div className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-2">
                ...
                <Input placeholder="Egyptian Tax Authority number" className="border-yellow-200 focus:ring-yellow-500"/>
              </div>
              
              <div className="space-y-2">
                <label className="text-sm font-medium text-yellow-700">VAT Registration</label>
                <Input placeholder="VAT registration number" className="border-yellow-200 focus:ring-yellow-500"/>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
              <div className="space-y-2">
                ...
                <Input placeholder="Commercial registration number" className="border-yellow-200 focus:ring-yellow-500"/>
              </div>
              
              <div className="space-y-2">
                <label className="text-sm font-medium text-yellow-700">License Expiry Date</label>
                <Input type="date" className="border-yellow-200 focus:ring-yellow-500"/>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input type="number" placeholder="25000" className="border-gray-200 focus:ring-gray-500"/>
              </div>
