...
const CategoryTable = ({ categories, isLoading, onDeleteCategory, }) => {
    if (isLoading) {
        ...
        <tbody>
          {categories.map((category) => (<tr key={category.id} className="border-b">
              ...
              <td className="py-3 px-2 text-right">
                <Button variant="ghost" size="sm" className="text-red-500 hover:text-red-700 hover:bg-red-50" onClick={() => onDeleteCategory(category)}>
