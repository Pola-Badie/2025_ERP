...
import { CloudIcon, HardDriveIcon, DatabaseIcon, DownloadIcon, UploadIcon, ClockIcon, ShieldIcon, LinkIcon, UnlinkIcon, PackageIcon, UsersIcon, TruckIcon, ShoppingCartIcon, FileTextIcon, ReceiptIcon, CalculatorIcon, UserIcon, SettingsIcon } from 'lucide-react';
const BackupTab = ({ preferences, refetch }) => {
    ...
    useEffect(() => {
        if (preferences) {
            const backupPrefs = preferences.filter((pref) => pref.category === 'backup');
    ...
    const handleChangeSetting = (key, value) => {
        ...
        const existingPref = preferences?.find((pref) => pref.key === fullKey);
        if (existingPref) {
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <div className="flex items-center justify-between p-4 border rounded-lg">
            ...
            <Switch id="autoBackup" checked={settings.autoBackup} onCheckedChange={(checked) => handleChangeSetting('autoBackup', checked)}/>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-3">
              <Label htmlFor="backupFrequency">Backup Frequency</Label>
              <Select value={settings.backupFrequency} onValueChange={(value) => handleChangeSetting('backupFrequency', value)} disabled={!settings.autoBackup}>
            ...
            <div className="space-y-3">
              ...
              <Input id="backupTime" type="time" value={settings.backupTime} onChange={(e) => handleChangeSetting('backupTime', e.target.value)} disabled={!settings.autoBackup}/>
              <p className="text-sm text-muted-foreground">
          ...
          <div className="space-y-3">
            ...
            <Input id="backupRetention" type="number" value={settings.backupRetention} onChange={(e) => handleChangeSetting('backupRetention', e.target.value)} min="1" max="365"/>
            <p className="text-sm text-muted-foreground">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between p-4 border rounded-lg">
            ...
            <Switch id="localBackup" checked={settings.localBackup} onCheckedChange={(checked) => handleChangeSetting('localBackup', checked)}/>
          </div>
          ...
          <div className="flex items-center justify-between p-4 border rounded-lg">
            ...
            <Switch id="cloudBackup" checked={settings.cloudBackup} onCheckedChange={(checked) => handleChangeSetting('cloudBackup', checked)}/>
          </div>

          {settings.cloudBackup && (<div className="space-y-3">
              <Label htmlFor="cloudProvider">Cloud Provider</Label>
              <Select value={settings.cloudProvider} onValueChange={(value) => handleChangeSetting('cloudProvider', value)}>
          ...
          {settings.cloudBackup && settings.cloudProvider === 'googledrive' && (<div className="space-y-3 p-4 border rounded-lg bg-blue-50">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                ...
                {settings.googleDriveEnabled ? (<Button variant="outline" size="sm" onClick={handleDisconnectGoogleDrive} className="border-red-200 text-red-600 hover:bg-red-50">
                    <UnlinkIcon className="h-4 w-4 mr-2"/>
                    Disconnect
                  </Button>) : (<Button size="sm" onClick={handleConnectGoogleDrive} className="bg-blue-600 hover:bg-blue-700">
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-center justify-between p-4 border rounded-lg">
              ...
              <Switch id="backupInventory" checked={settings.backupInventory} onCheckedChange={(checked) => handleChangeSetting('backupInventory', checked)}/>
            </div>
            ...
            <div className="flex items-center justify-between p-4 border rounded-lg">
              ...
              <Switch id="backupCustomers" checked={settings.backupCustomers} onCheckedChange={(checked) => handleChangeSetting('backupCustomers', checked)}/>
            </div>
            ...
            <div className="flex items-center justify-between p-4 border rounded-lg">
              ...
              <Switch id="backupSuppliers" checked={settings.backupSuppliers} onCheckedChange={(checked) => handleChangeSetting('backupSuppliers', checked)}/>
            </div>
            ...
            <div className="flex items-center justify-between p-4 border rounded-lg">
              ...
              <Switch id="backupOrders" checked={settings.backupOrders} onCheckedChange={(checked) => handleChangeSetting('backupOrders', checked)}/>
            </div>
            ...
            <div className="flex items-center justify-between p-4 border rounded-lg">
              ...
              <Switch id="backupInvoices" checked={settings.backupInvoices} onCheckedChange={(checked) => handleChangeSetting('backupInvoices', checked)}/>
            </div>
            ...
            <div className="flex items-center justify-between p-4 border rounded-lg">
              ...
              <Switch id="backupQuotations" checked={settings.backupQuotations} onCheckedChange={(checked) => handleChangeSetting('backupQuotations', checked)}/>
            </div>
            ...
            <div className="flex items-center justify-between p-4 border rounded-lg">
              ...
              <Switch id="backupExpenses" checked={settings.backupExpenses} onCheckedChange={(checked) => handleChangeSetting('backupExpenses', checked)}/>
            </div>
            ...
            <div className="flex items-center justify-between p-4 border rounded-lg">
              ...
              <Switch id="backupAccounting" checked={settings.backupAccounting} onCheckedChange={(checked) => handleChangeSetting('backupAccounting', checked)}/>
            </div>
            ...
            <div className="flex items-center justify-between p-4 border rounded-lg">
              ...
              <Switch id="backupUserData" checked={settings.backupUserData} onCheckedChange={(checked) => handleChangeSetting('backupUserData', checked)}/>
            </div>
            ...
            <div className="flex items-center justify-between p-4 border rounded-lg">
              ...
              <Switch id="backupSystemSettings" checked={settings.backupSystemSettings} onCheckedChange={(checked) => handleChangeSetting('backupSystemSettings', checked)}/>
            </div>
          </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between p-4 border rounded-lg">
            ...
            <Switch id="includeDatabase" checked={settings.includeDatabase} onCheckedChange={(checked) => handleChangeSetting('includeDatabase', checked)}/>
          </div>
          ...
          <div className="flex items-center justify-between p-4 border rounded-lg">
            ...
            <Switch id="includeFiles" checked={settings.includeFiles} onCheckedChange={(checked) => handleChangeSetting('includeFiles', checked)}/>
          </div>
          ...
          <div className="flex items-center justify-between p-4 border rounded-lg">
            ...
            <Switch id="encryptBackups" checked={settings.encryptBackups} onCheckedChange={(checked) => handleChangeSetting('encryptBackups', checked)}/>
          </div>
          ...
          <div className="flex items-center justify-between p-4 border rounded-lg">
            ...
            <Switch id="compressBackups" checked={settings.compressBackups} onCheckedChange={(checked) => handleChangeSetting('compressBackups', checked)}/>
          </div>
        </CardContent>
      </Card>
    </div>);
