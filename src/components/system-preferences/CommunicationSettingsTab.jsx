...
const CommunicationSettingsTab = ({ preferences, refetch }) => {
    ...
    useEffect(() => {
        if (preferences) {
            const commPrefs = preferences.filter((pref) => pref.category === 'communication');
            if (commPrefs.length) {
                const prefsObj = {};
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <div className="flex items-center justify-between p-4 border rounded-lg">
            ...
            <Switch id="emailEnabled" checked={settings.emailEnabled} onCheckedChange={(checked) => handleChangeSetting('emailEnabled', checked)}/>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-3">
              <Label htmlFor="smtpServer">SMTP Server</Label>
              <Input id="smtpServer" value={settings.smtpServer} onChange={(e) => handleChangeSetting('smtpServer', e.target.value)} placeholder="mail.example.com" disabled={!settings.emailEnabled}/>
              <p className="text-sm text-muted-foreground">
            ...
            <div className="space-y-3">
              ...
              <Select value={settings.smtpPort} onValueChange={(value) => handleChangeSetting('smtpPort', value)} disabled={!settings.emailEnabled}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-3">
              ...
              <Input id="smtpUsername" value={settings.smtpUsername} onChange={(e) => handleChangeSetting('smtpUsername', e.target.value)} placeholder="username@example.com" disabled={!settings.emailEnabled}/>
              <p className="text-sm text-muted-foreground">
            ...
            <div className="space-y-3">
              ...
              <Select value={settings.smtpSecurity} onValueChange={(value) => handleChangeSetting('smtpSecurity', value)} disabled={!settings.emailEnabled}>
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <div className="flex items-center justify-between p-4 border rounded-lg">
            ...
            <Switch id="smsEnabled" checked={settings.smsEnabled} onCheckedChange={(checked) => handleChangeSetting('smsEnabled', checked)}/>
          </div>

          <div className="space-y-3">
            <Label htmlFor="smsProvider">SMS Provider</Label>
            <Select value={settings.smsProvider} onValueChange={(value) => handleChangeSetting('smsProvider', value)} disabled={!settings.smsEnabled}>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="space-y-3">
            ...
            <Select value={settings.notificationFrequency} onValueChange={(value) => handleChangeSetting('notificationFrequency', value)}>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-4 border rounded-lg">
              ...
              <Switch id="lowStockNotifications" checked={settings.lowStockNotifications} onCheckedChange={(checked) => handleChangeSetting('lowStockNotifications', checked)}/>
            </div>
            ...
            <div className="flex items-center justify-between p-4 border rounded-lg">
              ...
              <Switch id="orderNotifications" checked={settings.orderNotifications} onCheckedChange={(checked) => handleChangeSetting('orderNotifications', checked)}/>
            </div>
            ...
            <div className="flex items-center justify-between p-4 border rounded-lg">
              ...
              <Switch id="paymentNotifications" checked={settings.paymentNotifications} onCheckedChange={(checked) => handleChangeSetting('paymentNotifications', checked)}/>
            </div>
            ...
            <div className="flex items-center justify-between p-4 border rounded-lg">
              ...
              <Switch id="systemNotifications" checked={settings.systemNotifications} onCheckedChange={(checked) => handleChangeSetting('systemNotifications', checked)}/>
            </div>
          </div>
        </CardContent>
      </Card>
