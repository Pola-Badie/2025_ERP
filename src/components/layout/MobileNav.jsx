    ...
    return (<>
      <div className="md:hidden fixed bottom-0 inset-x-0 bg-white border-t border-slate-200 z-30 shadow-lg">
        <div className="grid grid-cols-5 h-16 safe-area-inset-bottom">
          <Link href="/">
            <div className={cn("flex flex-col items-center justify-center cursor-pointer", location === "/" ? "text-primary" : "text-slate-500")}>
          ...
          <Link href="/inventory">
            <div className={cn("flex flex-col items-center justify-center cursor-pointer", location === "/inventory" ? "text-primary" : "text-slate-500")}>
          ...
          <Link href="/procurement">
            <div className={cn("flex flex-col items-center justify-center cursor-pointer", location === "/procurement" ? "text-primary" : "text-slate-500")}>
              <ShoppingBag size={20}/>
          ...
          <Link href="/suppliers">
            <div className={cn("flex flex-col items-center justify-center cursor-pointer", location === "/suppliers" ? "text-primary" : "text-slate-500")}>
          ...
          <Link href="/accounting">
            <div className={cn("flex flex-col items-center justify-center cursor-pointer", location === "/accounting" ? "text-primary" : "text-slate-500")}>
