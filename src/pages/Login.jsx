            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(handleLogin)} className="space-y-4">
                <FormField control={form.control} name="email" render={({ field }) => (<FormItem>
                      ...
                      <FormControl>
                        <div className="relative">
                          ...
                          <Input placeholder={t('enterEmail')} className="pl-10" {...field}/>
                        </div>
                      </FormControl>
                      <FormMessage />
                    </FormItem>)}/>
                ...
                <FormField control={form.control} name="password" render={({ field }) => (<FormItem>
                      ...
                      <FormControl>
                        <div className="relative">
                          <Input type={showPassword ? "text" : "password"} placeholder={t('enterPassword')} className="pr-10" {...field}/>
                ...
                <Button type="submit" className="w-full" disabled={isLoading}>
                  {isLoading ? (<LoaderIcon className="w-4 h-4 mr-2 animate-spin"/>) : (<LogInIcon className="w-4 h-4 mr-2"/>)}
                  {t('signIn')}
                </Button>
              </form>
            </Form>
