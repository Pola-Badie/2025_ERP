...
const PurchaseOrderForm = ({ onSuccess, initialData, }) => {
      ...
      <div className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <Select value={watch('supplierId')?.toString() || ''} onValueChange={(value) => setValue('supplierId', parseInt(value))}>
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-end">
                    ...
                    <Command>
                      ...
                      <CommandEmpty>
                        <div className="p-2 text-sm text-gray-500">
                          No products found.
                          <Button variant="outline" size="sm" className="ml-2" onClick={() => setShowProductDialog(true)}>
                      ...
                      <CommandGroup>
                        {products?.map((product) => (<CommandItem key={product.id} value={product.id.toString()} onSelect={(value) => {
                setCurrentItem({
                    ...currentItem,
                    ...
                    unitPrice: product.price
                            ...
                            <Check className={cn("mr-2 h-4 w-4", currentItem.productId === product.id
                ? "opacity-100"
                : "opacity-0")}/>
            ...
            <div className="w-full sm:w-1/4">
              ...
              <Input id="quantity" type="number" min="1" value={currentItem.quantity} onChange={(e) => setCurrentItem({ ...currentItem, quantity: parseInt(e.target.value) || 0 })}/>
            </div>
            <Button type="button" onClick={handleAddItem} className="w-full sm:w-auto" disabled={!currentItem.productId}>
              <Plus className="h-4 w-4 mr-2"/>
              Add Item
            </Button>
          </div>

          {items.length > 0 ? (<div className="border rounded-md">
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {items.map((item, index) => (<tr key={index}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <Button type="button" variant="ghost" onClick={() => handleRemoveItem(index)} className="text-red-600 hover:text-red-900">
            ...
            </div>) : (<div className="text-center py-8 text-gray-500 border rounded-md">
          ...
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="price" type="number" min="0" step="0.01" value={newProduct.price} onChange={(e) => setNewProduct({ ...newProduct, price: parseFloat(e.target.value) || 0 })} placeholder="0.00"/>
              </div>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                <Label htmlFor="uom">Unit of Measure</Label>
                <Select value={newProduct.uom} onValueChange={(value) => setNewProduct({ ...newProduct, uom: value })}>
            ...
            <div className="space-y-2">
              ...
              <Input id="description" value={newProduct.description} onChange={(e) => setNewProduct({ ...newProduct, description: e.target.value })} placeholder="Enter product description"/>
            </div>
          </div>
          <DialogFooter>
            ...
            <Button type="button" onClick={handleCreateProduct} disabled={createProductMutation.isPending}>
