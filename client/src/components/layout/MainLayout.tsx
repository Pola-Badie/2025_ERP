  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex-1 flex flex-col overflow-auto md:pl-64">
        ...
        {/* CSV Import/Export Buttons - Will be visible only when the context provides data/handlers */}
        <div className="flex items-center gap-2 px-4 md:px-6 py-2 bg-white border-b">
          <div id="csv-import-export-container" className="flex items-center gap-2">
            {/* 
              This empty container will be used by components to inject their
              CSV import/export buttons using React.createPortal
            */}
          </div>
        </div>
