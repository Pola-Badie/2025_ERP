...
const MainLayout = ({ children }) => {
    ...
    return (<div className={`flex h-screen bg-slate-100 ${isRTL ? 'rtl' : 'ltr'}`} dir={isRTL ? 'rtl' : 'ltr'}>
      {/* Desktop Sidebar */}
      ...
      {isMobileMenuOpen && (<div className="fixed inset-0 z-50 md:hidden">
          ...
          <div className={`fixed top-0 bottom-0 w-80 max-w-[85vw] bg-white shadow-2xl transform transition-transform duration-300 ease-in-out ${isRTL
        ...
        <div className="hidden md:flex border-b border-slate-200 bg-white px-6 py-4 sticky top-0 z-30">
          <div className="flex items-center justify-between w-full">
            <div className={`flex items-center ${isRTL ? 'space-x-reverse space-x-3' : 'space-x-3'}`}>
              <img src="/attached_assets/Untitled design-7_1749347391766.png" alt="Morgan ERP Logo" className="w-12 h-12 object-contain"/>
            ...
            <div className={`flex items-center ${isRTL ? 'space-x-reverse space-x-3' : 'space-x-3'}`}>
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" className="relative h-12 w-12 rounded-full p-0 border-2 border-transparent hover:border-blue-200 hover:shadow-lg transition-all duration-200 hover:scale-105 group">
                    <div className="relative">
                      <img className="w-10 h-10 rounded-full object-cover ring-2 ring-white shadow-md group-hover:ring-blue-300 transition-all duration-200" src={user?.avatar || "https://images.unsplash.com/photo-1560250097-0b93528c311a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=256&q=80"} alt={user?.name || "User"}/>
                ...
                <DropdownMenuContent className="w-80 p-0 shadow-xl border-0 bg-white/95 backdrop-blur-md rounded-xl" align="end" forceMount>
                  <DropdownMenuLabel className="font-normal p-6 bg-gradient-to-br from-blue-50 to-indigo-100 rounded-t-xl">
                    <div className="flex flex-col items-center text-center space-y-3">
                      <div className="relative">
                        <img className="w-16 h-16 rounded-full object-cover ring-4 ring-white shadow-lg" src={user?.avatar || "https://images.unsplash.com/photo-1560250097-0b93528c311a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=256&q=80"} alt={user?.name || "User"}/>
                  ...
                  <div className="p-3 space-y-1">
                    <DropdownMenuItem onClick={() => setProfileDialogOpen(true)} className="flex items-center px-4 py-3 rounded-lg hover:bg-blue-50 hover:text-blue-700 transition-all duration-200 cursor-pointer group">
                    ...
                    <DropdownMenuItem onClick={() => setSettingsDialogOpen(true)} className="flex items-center px-4 py-3 rounded-lg hover:bg-gray-50 hover:text-gray-700 transition-all duration-200 cursor-pointer group">
                  ...
                  <div className="p-3">
                    <DropdownMenuItem onClick={() => setLogoutDialogOpen(true)} className="flex items-center px-4 py-3 rounded-lg hover:bg-red-50 hover:text-red-700 transition-all duration-200 cursor-pointer text-red-600 group">
        ...
        <div className={`md:hidden border-b border-slate-200 bg-white px-3 py-3 sticky top-0 z-30 ${isRTL ? 'direction-rtl' : ''}`}>
          <div className={`flex items-center justify-between ${isRTL ? 'flex-row-reverse' : ''}`}>
            <div className={`flex items-center min-w-0 flex-1 ${isRTL ? 'flex-row-reverse' : ''}`}>
              <button type="button" className="text-slate-600 hover:text-slate-900 p-2 rounded-md hover:bg-slate-100 transition-colors" onClick={toggleMobileMenu}>
              ...
              <div className={`flex items-center min-w-0 ${isRTL ? 'mr-2' : 'ml-2'}`}>
                <img src="/attached_assets/Untitled design-7_1749347391766.png" alt="Morgan ERP Logo" className="w-8 h-8 object-contain flex-shrink-0"/>
              ...
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" className="relative h-9 w-9 rounded-full p-0">
                    <img className="w-8 h-8 rounded-full object-cover ring-2 ring-white shadow-sm" src={user?.avatar || "https://images.unsplash.com/photo-1560250097-0b93528c311a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=256&q=80"} alt={user?.name || "User"}/>
                  </Button>
                </DropdownMenuTrigger>
                  ...
                  <DropdownMenuLabel className="font-normal p-4">
                    <div className="flex flex-col space-y-2">
                      <div className="flex items-center space-x-3">
                        <img className="w-10 h-10 rounded-full object-cover" src={user?.avatar || "https://images.unsplash.com/photo-1560250097-0b93528c311a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=256&q=80"} alt={user?.name || "User"}/>
