...
const Sidebar: React.FC<SidebarProps> = ({ className, isMobile, onClose }) => {
  ...
  const navItems = [
    { path: '/', key: 'navigation.dashboard', icon: 'home' },
    { path: '/customers-demo', key: 'navigation.customers', icon: 'user-plus' },
    { path: '/create-quotation', key: 'navigation.createQuotation', icon: 'quote' },
    { path: '/quotation-history', key: 'navigation.quotationHistory', icon: 'clipboard-list' },
    { path: '/create-invoice', key: 'navigation.createInvoice', icon: 'file-plus' },
    { path: '/invoice-history', key: 'navigation.invoiceHistory', icon: 'receipt' },
    { path: '/order-management', key: 'navigation.orders', icon: 'factory' },
    { path: '/orders-history', key: 'navigation.orderHistory', icon: 'history' },
    { path: '/suppliers', key: 'navigation.suppliers', icon: 'truck' },
    { path: '/procurement', key: 'navigation.procurement', icon: 'shopping-bag' },
    { path: '/inventory', key: 'navigation.inventory', icon: 'package' },
    { path: '/label', key: 'navigation.labelGenerator', icon: 'file-text' },
    { path: '/expenses', key: 'navigation.expenses', icon: 'dollar-sign' },
    { path: '/accounting', key: 'navigation.accounting', icon: 'landmark' },
    { path: '/reports', key: 'navigation.reports', icon: 'pie-chart' },
    { path: '/users', key: 'navigation.userManagement', icon: 'users' },
    { path: '/system-preferences', key: 'navigation.systemPreferences', icon: 'sliders' },
  ];
