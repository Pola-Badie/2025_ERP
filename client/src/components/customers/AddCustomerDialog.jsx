...
const AddCustomerDialog = ({ open, onOpenChange, onSave }) => {
          ...
          <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="space-y-2">
                ...
                <Input id="name" name="name" placeholder={t('fullCustomerName')} value={customer.name || ''} onChange={handleInputChange} className={`border-blue-200 focus:ring-blue-500 ${nameError ? "border-red-500" : ""}`}/>
                {nameError && (<p className="text-sm text-red-500">{nameError}</p>)}
              </div>
              
              <div className="space-y-2">
                <Label htmlFor="position" className="text-blue-700 font-medium">{t('positionTitle')}</Label>
                <Input id="position" name="position" placeholder={t('jobTitlePosition')} value={customer.position || ''} onChange={handleInputChange} className="border-blue-200 focus:ring-blue-500"/>
              </div>
          ...
          <div className="bg-green-50 p-4 rounded-lg border border-green-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input id="company" name="company" placeholder={t('fullCompanyName')} value={customer.company || ''} onChange={handleInputChange} className="border-green-200 focus:ring-green-500"/>
              </div>
              
              <div className="space-y-2">
                <Label htmlFor="sector" className="text-green-700 font-medium">{t('industrySector')}</Label>
                <Select defaultValue={customer.sector} onValueChange={handleSectorChange}>
          ...
          <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input id="phone" name="phone" placeholder={t('phoneNumber')} value={customer.phone || ''} onChange={handleInputChange} className="border-purple-200 focus:ring-purple-500"/>
              </div>
              
              <div className="space-y-2">
                <Label htmlFor="email" className="text-purple-700 font-medium">{t('emailAddress')}</Label>
                <Input id="email" name="email" type="email" placeholder="customer@example.com" value={customer.email || ''} onChange={handleInputChange} className="border-purple-200 focus:ring-purple-500"/>
              </div>
            </div>
          </div>
          ...
          <div className="bg-orange-50 p-4 rounded-lg border border-orange-200">
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <Textarea id="address" name="address" placeholder={t('customerAddress')} value={customer.address || ''} onChange={handleInputChange} className="min-h-[80px] border-orange-200 focus:ring-orange-500"/>
              </div>
              
              <div className="space-y-2">
                <Label htmlFor="taxNumber" className="text-orange-700 font-medium">{t('taxNumberEta')}</Label>
                <Input id="taxNumber" name="taxNumber" placeholder={t('enterTaxNumber')} value={customer.taxNumber || ''} onChange={handleInputChange} className="border-orange-200 focus:ring-orange-500"/>
