...
import { Smartphone, Tablet, Monitor, Eye, Touchpad, Zap } from 'lucide-react';
export default function MobileOptimization() {
    ...
    const getOptimizationScore = () => {
        let score = 0;
        if (mobileSettings.enableTouchGestures)
            score += 20;
        if (mobileSettings.largerButtons)
            score += 20;
        if (mobileSettings.simplifiedNavigation)
            score += 20;
        if (mobileSettings.compactLayout)
            score += 20;
        if (mobileSettings.autoHideHeaders)
            score += 20;
        return score;
    };
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="text-center space-y-4">
              ...
              <div className="space-y-2">
                <div className="w-full bg-secondary rounded-full h-2">
                  <div className="bg-primary h-2 rounded-full transition-all duration-300" style={{ width: `${getOptimizationScore()}%` }}/>
                </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <Button className="w-full" onClick={() => setMobileSettings(prev => ({ ...prev, largerButtons: !prev.largerButtons }))}>
              {mobileSettings.largerButtons ? 'Disable' : 'Enable'} Large Buttons
            </Button>
            <Button variant="outline" className="w-full" onClick={() => setMobileSettings(prev => ({ ...prev, simplifiedNavigation: !prev.simplifiedNavigation }))}>
              {mobileSettings.simplifiedNavigation ? 'Disable' : 'Enable'} Simple Navigation
            </Button>
            <Button variant="outline" className="w-full" onClick={() => setMobileSettings(prev => ({ ...prev, compactLayout: !prev.compactLayout }))}>
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Button variant={mobileSettings.enableTouchGestures ? "default" : "outline"} size="sm" onClick={() => setMobileSettings(prev => ({ ...prev, enableTouchGestures: !prev.enableTouchGestures }))}>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Button variant={mobileSettings.largerButtons ? "default" : "outline"} size="sm" onClick={() => setMobileSettings(prev => ({ ...prev, largerButtons: !prev.largerButtons }))}>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Button variant={mobileSettings.simplifiedNavigation ? "default" : "outline"} size="sm" onClick={() => setMobileSettings(prev => ({ ...prev, simplifiedNavigation: !prev.simplifiedNavigation }))}>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Button variant={mobileSettings.compactLayout ? "default" : "outline"} size="sm" onClick={() => setMobileSettings(prev => ({ ...prev, compactLayout: !prev.compactLayout }))}>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Button variant={mobileSettings.autoHideHeaders ? "default" : "outline"} size="sm" onClick={() => setMobileSettings(prev => ({ ...prev, autoHideHeaders: !prev.autoHideHeaders }))}>
              ...
              <div className="bg-muted p-4 rounded-lg">
                <div className="bg-background border rounded p-4 max-w-sm mx-auto">
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                      <Button className="w-full" size={mobileSettings.largerButtons ? "default" : "sm"}>
                        Add Product
                      </Button>
                      <Button variant="outline" className="w-full" size={mobileSettings.largerButtons ? "default" : "sm"}>
                        View Orders
                      </Button>
                    </div>
                  </div>
