...
const ETAIntegrationTab = ({ preferences, refetch }) => {
    ...
    useEffect(() => {
        if (preferences) {
            const etaPrefs = preferences.filter((pref) => pref.category === 'eta');
            if (etaPrefs.length) {
                const prefsObj = {};
                etaPrefs.forEach((pref) => {
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <div className="flex items-center justify-between p-4 border rounded-lg">
            ...
            <Switch id="etaEnabled" checked={settings.etaEnabled} onCheckedChange={(checked) => handleChangeSetting('etaEnabled', checked)}/>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-3">
              <Label htmlFor="environment">Environment</Label>
              <Select value={settings.environment} onValueChange={(value) => handleChangeSetting('environment', value)} disabled={!settings.etaEnabled}>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <Switch id="testMode" checked={settings.testMode} onCheckedChange={(checked) => handleChangeSetting('testMode', checked)} disabled={!settings.etaEnabled}/>
              </div>
              <p className="text-sm text-muted-foreground">
          ...
          <div className="flex items-center justify-between p-4 border rounded-lg">
            ...
            <Switch id="autoSubmit" checked={settings.autoSubmit} onCheckedChange={(checked) => handleChangeSetting('autoSubmit', checked)} disabled={!settings.etaEnabled}/>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-3">
              ...
              <Input id="clientId" type="text" value={settings.clientId} onChange={(e) => handleChangeSetting('clientId', e.target.value)} placeholder="Enter your ETA Client ID" disabled={!settings.etaEnabled}/>
              <p className="text-sm text-muted-foreground">
            ...
            <div className="space-y-3">
              ...
              <Input id="clientSecret" type="password" value={settings.clientSecret} onChange={(e) => handleChangeSetting('clientSecret', e.target.value)} placeholder="Enter your ETA Client Secret" disabled={!settings.etaEnabled}/>
              <p className="text-sm text-muted-foreground">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-3">
              ...
              <Input id="username" type="text" value={settings.username} onChange={(e) => handleChangeSetting('username', e.target.value)} placeholder="Enter your ETA username" disabled={!settings.etaEnabled}/>
              <p className="text-sm text-muted-foreground">
            ...
            <div className="space-y-3">
              ...
              <Input id="pin" type="password" value={settings.pin} onChange={(e) => handleChangeSetting('pin', e.target.value)} placeholder="Enter your ETA PIN" disabled={!settings.etaEnabled}/>
              <p className="text-sm text-muted-foreground">
          ...
          <div className="space-y-3">
            ...
            <Input id="apiKey" type="password" value={settings.apiKey} onChange={(e) => handleChangeSetting('apiKey', e.target.value)} placeholder="Enter your ETA API Key" disabled={!settings.etaEnabled}/>
            <p className="text-sm text-muted-foreground">
        ...
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-3">
              ...
              <Input id="taxNumber" type="text" value={settings.taxNumber} onChange={(e) => handleChangeSetting('taxNumber', e.target.value)} placeholder="Enter tax registration number" disabled={!settings.etaEnabled}/>
              <p className="text-sm text-muted-foreground">
            ...
            <div className="space-y-3">
              ...
              <Input id="branchId" type="text" value={settings.branchId} onChange={(e) => handleChangeSetting('branchId', e.target.value)} placeholder="Enter branch identifier" disabled={!settings.etaEnabled}/>
              <p className="text-sm text-muted-foreground">
          ...
          <div className="space-y-3">
            ...
            <Input id="activityCode" type="text" value={settings.activityCode} onChange={(e) => handleChangeSetting('activityCode', e.target.value)} placeholder="Enter business activity code" disabled={!settings.etaEnabled}/>
            <p className="text-sm text-muted-foreground">
