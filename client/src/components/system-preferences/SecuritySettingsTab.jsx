...
const SecuritySettingsTab = ({ preferences, refetch }) => {
    ...
    useEffect(() => {
        if (preferences) {
            const securityPrefs = preferences.filter((pref) => pref.category === 'security');
        ...
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-3">
              ...
              <Input id="passwordMinLength" type="number" value={settings.passwordMinLength} onChange={(e) => handleChangeSetting('passwordMinLength', e.target.value)} min="6" max="20"/>
              <p className="text-sm text-muted-foreground">
            ...
            <div className="space-y-3">
              ...
              <Input id="loginAttempts" type="number" value={settings.loginAttempts} onChange={(e) => handleChangeSetting('loginAttempts', e.target.value)} min="3" max="10"/>
              <p className="text-sm text-muted-foreground">
          ...
          <div className="flex items-center justify-between p-4 border rounded-lg">
            ...
            <Switch id="passwordComplexity" checked={settings.passwordComplexity} onCheckedChange={(checked) => handleChangeSetting('passwordComplexity', checked)}/>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-3">
              ...
              <Select value={settings.sessionTimeout} onValueChange={(value) => handleChangeSetting('sessionTimeout', value)}>
          ...
          <div className="flex items-center justify-between p-4 border rounded-lg">
            ...
            <Switch id="twoFactorAuth" checked={settings.twoFactorAuth} onCheckedChange={(checked) => handleChangeSetting('twoFactorAuth', checked)}/>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between p-4 border rounded-lg">
            ...
            <Switch id="auditLogging" checked={settings.auditLogging} onCheckedChange={(checked) => handleChangeSetting('auditLogging', checked)}/>
          </div>
          ...
          <div className="flex items-center justify-between p-4 border rounded-lg">
            ...
            <Switch id="accessLogging" checked={settings.accessLogging} onCheckedChange={(checked) => handleChangeSetting('accessLogging', checked)}/>
          </div>
          ...
          <div className="flex items-center justify-between p-4 border rounded-lg">
            ...
            <Switch id="dataEncryption" checked={settings.dataEncryption} onCheckedChange={(checked) => handleChangeSetting('dataEncryption', checked)}/>
          </div>
        </CardContent>
      </Card>
    </div>);
