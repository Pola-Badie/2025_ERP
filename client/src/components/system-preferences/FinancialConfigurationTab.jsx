...
const FinancialConfigurationTab = ({ preferences, refetch }) => {
    ...
    useEffect(() => {
        if (preferences) {
            const financialPrefs = preferences.filter((pref) => pref.category === 'financial');
            if (financialPrefs.length) {
                const prefsObj = {};
                financialPrefs.forEach((pref) => {
        ...
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-3">
              ...
              <Select value={settings.baseCurrency} onValueChange={(value) => handleChangeSetting('baseCurrency', value)}>
            ...
            <div className="space-y-3">
              ...
              <Input id="vatRate" type="number" value={settings.vatRate} onChange={(e) => handleChangeSetting('vatRate', e.target.value)} min="0" max="30" step="0.1"/>
              <p className="text-sm text-muted-foreground">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex items-center justify-between p-4 border rounded-lg">
              ...
              <Switch id="multiCurrency" checked={settings.multiCurrency} onCheckedChange={(checked) => handleChangeSetting('multiCurrency', checked)}/>
            </div>
            ...
            <div className="flex items-center justify-between p-4 border rounded-lg">
              ...
              <Switch id="taxInclusive" checked={settings.taxInclusive} onCheckedChange={(checked) => handleChangeSetting('taxInclusive', checked)}/>
            </div>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-3">
              ...
              <Input id="invoicePrefix" value={settings.invoicePrefix} onChange={(e) => handleChangeSetting('invoicePrefix', e.target.value)} placeholder="INV"/>
              <p className="text-sm text-muted-foreground">
            ...
            <div className="space-y-3">
              ...
              <Input id="quotationPrefix" value={settings.quotationPrefix} onChange={(e) => handleChangeSetting('quotationPrefix', e.target.value)} placeholder="QUO"/>
              <p className="text-sm text-muted-foreground">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-3">
              ...
              <Input id="fiscalYearStart" value={settings.fiscalYearStart} onChange={(e) => handleChangeSetting('fiscalYearStart', e.target.value)} placeholder="MM-DD"/>
              <p className="text-sm text-muted-foreground">
            ...
            <div className="space-y-3">
              ...
              <Select value={settings.discountCalculation} onValueChange={(value) => handleChangeSetting('discountCalculation', value)}>
          ...
          <div className="flex items-center justify-between p-4 border rounded-lg">
            ...
            <Switch id="autoNumbering" checked={settings.autoNumbering} onCheckedChange={(checked) => handleChangeSetting('autoNumbering', checked)}/>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-3">
              ...
              <Input id="paymentTerms" type="number" value={settings.paymentTerms} onChange={(e) => handleChangeSetting('paymentTerms', e.target.value)} min="0" max="365"/>
              <p className="text-sm text-muted-foreground">
            ...
            <div className="space-y-3">
              ...
              <Input id="creditLimit" type="number" value={settings.creditLimit} onChange={(e) => handleChangeSetting('creditLimit', e.target.value)} min="0"/>
              <p className="text-sm text-muted-foreground">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center justify-between p-4 border rounded-lg">
            ...
            <Switch id="etaIntegration" checked={settings.etaIntegration} onCheckedChange={(checked) => handleChangeSetting('etaIntegration', checked)}/>
          </div>
        </CardContent>
      </Card>
    </div>);
