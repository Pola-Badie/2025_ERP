...
const FinancialSettingsTab = ({ preferences, refetch }) => {
    ...
    const handleSaveAll = async () => {
        ...
        try {
            ...
            const settingsToSave = Object.entries(settings).map(([key, value]) => ({
                key: `financial_${key}`,
                value,
                existingPref: preferences?.find((pref) => pref.key === `financial_${key}`),
            }));
    ...
    return (<div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-3">
          ...
          <Select value={settings.currency} onValueChange={(value) => handleChangeSetting('currency', value)}>
        ...
        <div className="space-y-3">
          ...
          <Input id="taxPercentage" type="number" value={settings.taxPercentage} onChange={(e) => handleChangeSetting('taxPercentage', e.target.value)} min="0" max="100"/>
          <p className="text-sm text-muted-foreground">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-3">
          ...
          <Select value={settings.paymentTerms} onValueChange={(value) => handleChangeSetting('paymentTerms', value)}>
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <Switch id="allowPartialPayments" checked={settings.allowPartialPayments} onCheckedChange={(checked) => handleChangeSetting('allowPartialPayments', checked)}/>
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <Switch id="autoStockDeduction" checked={settings.autoStockDeduction} onCheckedChange={(checked) => handleChangeSetting('autoStockDeduction', checked)}/>
        </div>
      </div>
    </div>);
};
