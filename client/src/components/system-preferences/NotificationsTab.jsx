...
const NotificationsTab = ({ preferences, refetch }) => {
    ...
    useEffect(() => {
        if (preferences) {
            const notificationPrefs = preferences.filter((pref) => pref.category === 'notifications');
    ...
    const handleSaveAll = async () => {
        ...
        try {
            ...
            const settingsToSave = Object.entries(settings).map(([key, value]) => ({
                ...
                value,
                existingPref: preferences?.find((pref) => pref.key === `notifications_${key}`),
            }));
    ...
    return (<div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-3">
          ...
          <Input id="expiryAlertDays" type="number" value={settings.expiryAlertDays} onChange={(e) => handleChangeSetting('expiryAlertDays', e.target.value)} min="1"/>
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <Switch id="lowStockAlerts" checked={settings.lowStockAlerts} onCheckedChange={(checked) => handleChangeSetting('lowStockAlerts', checked)}/>
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <Switch id="stockoutAlerts" checked={settings.stockoutAlerts} onCheckedChange={(checked) => handleChangeSetting('stockoutAlerts', checked)}/>
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <Switch id="criticalErrorNotifications" checked={settings.criticalErrorNotifications} onCheckedChange={(checked) => handleChangeSetting('criticalErrorNotifications', checked)}/>
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <Switch id="emailNotifications" checked={settings.emailNotifications} onCheckedChange={(checked) => handleChangeSetting('emailNotifications', checked)}/>
        </div>
      </div>
    </div>);
};
