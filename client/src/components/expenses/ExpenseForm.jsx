...
const ExpenseForm = ({ onSuccess, expenseId }) => {
    ...
    return (<Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <FormField control={form.control} name="costCenter" render={({ field }) => (<FormItem>
        ...
        <FormField control={form.control} name="receipt" render={() => (<FormItem>
        ...
        <div className="flex justify-end space-x-2 pt-4">
          ...
          <Button type="submit" disabled={createExpense.isPending} className="bg-blue-600 hover:bg-blue-700 text-white">
