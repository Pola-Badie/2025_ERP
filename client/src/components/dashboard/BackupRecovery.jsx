      ...
      <CardContent className="p-6">
        ...
        <div className="bg-slate-50 p-4 rounded-lg mb-4">
          <div className="flex justify-between items-center mb-2">
            ...
            {isLoadingBackup ? (<div className="h-5 w-20 bg-slate-200 animate-pulse rounded"></div>) : latestBackup ? (<span className="text-xs text-green-600 bg-green-50 px-2 py-0.5 rounded-full font-medium">
                {latestBackup.status}
              </span>) : (<span className="text-xs text-amber-600 bg-amber-50 px-2 py-0.5 rounded-full font-medium">
                No backups
              </span>)}
          </div>
          
          {isLoadingBackup ? (<div className="space-y-2">
        ...
        <div>
          ...
          <Button className="w-full mb-2" onClick={handleRestoreFromLatest} disabled={!latestBackup || isRestoring}>
          ...
          <Button variant="outline" className="w-full" onClick={handleViewBackupHistory}>
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mr-2">
              <path d="M3 3v5h5"></path>
