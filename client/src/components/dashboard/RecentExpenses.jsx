    ...
    return (<Card>
      <CardContent className="p-6">
        ...
        {isLoading ? (<div className="space-y-4">
          ...
          </div>) : recentExpenses.length === 0 ? (<div className="text-center py-12">
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {recentExpenses.map((expense) => (<tr key={expense.id} className="border-b border-slate-100 hover:bg-slate-50">
