...
import { Activity, Wifi, WifiOff, RefreshCw, Bell, TrendingUp, AlertCircle, Clock } from 'lucide-react';
...
export default function RealTimeDashboard() {
    ...
    return (<div className="space-y-6">
        ...
        <CardContent className="p-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              {lastActivity && (<span className="text-sm text-muted-foreground">
            ...
            <div className="flex items-center gap-4">
              <div className="flex items-center gap-2">
                ...
                <Switch id="real-time" checked={isRealTimeEnabled} onCheckedChange={toggleRealTime}/>
              </div>
      ...
      <div className={`grid gap-4 ${isMobile()
            ? 'grid-cols-1'
            : 'grid-cols-1 md:grid-cols-2 lg:grid-cols-4'}`}>{keyMetrics}</div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="flex items-center gap-4">
            <div className={`h-3 w-3 rounded-full ${data.systemHealth === 'healthy' ? 'bg-green-500' :
            data.systemHealth === 'warning' ? 'bg-yellow-500' :
                'bg-red-500'}`}/>
            <span className="font-medium capitalize">{data.systemHealth}</span>
            <Badge variant={data.systemHealth === 'healthy' ? 'default' :
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-3">
            {data.recentActivities.slice(0, 10).map((activity) => (<div key={activity.id} className="flex items-start gap-3 p-3 bg-muted rounded-lg">
                <div className={`h-2 w-2 rounded-full mt-2 ${activity.severity === 'high' ? 'bg-red-500' :
      ...
      {!isConnected && isRealTimeEnabled && (<Alert>
