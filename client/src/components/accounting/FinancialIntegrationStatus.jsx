...
const FinancialIntegrationStatus = () => {
    ...
    return (<div className="mb-6 space-y-4">
      ...
      <Card>
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            ...
            <Button variant="outline" size="sm" onClick={handleRefreshStatus} disabled={isRefreshing} className="h-8 px-2">
      ...
      {integrationStatus?.summary && (<div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <Card>
      ...
      {integrationStatus?.status === 'active' && integrationStatus?.accountingIntegration === 'connected' ? (<Alert>
