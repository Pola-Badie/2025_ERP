...
import { Download, FileText, RefreshCw, CheckCircle2, AlertCircle, Image, FileSpreadsheet } from "lucide-react";
...
const BalanceSheet = () => {
    ...
    return (<div className="space-y-6">
      ...
      {isLoading ? (<div className="flex justify-center items-center h-64">
        ...
        </div>) : !data ? (<div className="bg-muted/30 p-8 rounded-lg border border-dashed flex flex-col items-center justify-center text-center">
        ...
        </div>) : (<Card className="w-full" id="balance-sheet-report">
          <CardHeader className="bg-navy-700 text-white text-center py-3">
            ...
            <div className="flex justify-center">
              {data.isBalanced ? (<Badge variant="outline" className="bg-green-50 text-green-700 border-green-200 flex items-center text-xs">
                  <CheckCircle2 className="h-3 w-3 mr-1"/>
                  Balanced
                </Badge>) : (<Badge variant="outline" className="bg-red-50 text-red-700 border-red-200 flex items-center text-xs">
          ...
          <CardContent className="space-y-6 p-6">
            ...
            {(categoryFilter === "all" || categoryFilter === "assets") && (<>
                <div>
                  ...
                  <Table>
                    ...
                    <TableBody>
                      {data.assets.byCategory.map((category) => (<React.Fragment key={category.name}>
                          {/* Category header */}
                          ...
                          {/* Category accounts */}
                          {category.accounts.map((account) => (<TableRow key={account.id}>
            ...
            {(categoryFilter === "all" || categoryFilter === "liabilities") && (<>
                <div>
                  ...
                  <Table>
                    ...
                    <TableBody>
                      {data.liabilities.byCategory.map((category) => (<React.Fragment key={category.name}>
                          {/* Category header */}
                          <TableRow className="bg-gray-100">
                            <TableCell colSpan={3} className="font-medium">
                              {category.name}
            ...
            {(categoryFilter === "all" || categoryFilter === "equity") && (<>
                <div>
                  ...
                  <Table>
                    ...
                    <TableBody>
                      {data.equity.byCategory.map((category) => (<React.Fragment key={category.name}>
                          {/* Category header */}
                          <TableRow className="bg-gray-100">
                            <TableCell colSpan={3} className="font-medium">
                              {category.name}
            ...
            {categoryFilter === "all" && (<>
                ...
                <div className="flex justify-center mt-4">
                  {data.isBalanced ? (<div className="flex items-center text-green-700">
                    ...
                    </div>) : (<div className="flex items-center text-red-700">
