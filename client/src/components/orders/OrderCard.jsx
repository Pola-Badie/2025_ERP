...
export function OrderCard({ order, onViewDetails, onCreateInvoice, onDelete }) {
    ...
    return (<Card className={`hover:shadow-md transition-shadow border-l-4 ${getOrderTypeColor(order.orderType)}`}>
      ...
      <CardContent className="pt-0">
        <div className="space-y-3">
          ...
          <div className="flex gap-2">
            ...
            <Button variant="default" size="sm" onClick={() => onCreateInvoice(order)} className="flex-1">
