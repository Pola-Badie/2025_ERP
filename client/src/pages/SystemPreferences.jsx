...
import { UsersIcon, PackageIcon, DollarSignIcon, ShieldIcon, MessageSquareIcon, CloudIcon, FileTextIcon, SettingsIcon, ReceiptIcon, FileDownIcon, Building2Icon, TagIcon } from 'lucide-react';
        ...
        <CardContent className="p-0">
          <Tabs defaultValue="users" value={activeTab} onValueChange={setActiveTab} className="w-full">
            <TabsList className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-12 border-b rounded-none h-auto gap-1">
              <TabsTrigger value="company" className="flex items-center justify-center py-3 px-1 text-xs lg:text-sm data-[state=active]:border-b-2 data-[state=active]:border-primary rounded-none min-w-0">
                {renderTabIcon('company')}
                <span className="hidden sm:inline ml-1 truncate">Company</span>
              </TabsTrigger>
              <TabsTrigger value="users" className="flex items-center justify-center py-3 px-1 text-xs lg:text-sm data-[state=active]:border-b-2 data-[state=active]:border-primary rounded-none min-w-0">
                {renderTabIcon('users')}
                <span className="hidden sm:inline ml-1 truncate">Users</span>
              </TabsTrigger>
              <TabsTrigger value="inventory" className="flex items-center justify-center py-3 px-1 text-xs lg:text-sm data-[state=active]:border-b-2 data-[state=active]:border-primary rounded-none min-w-0">
                {renderTabIcon('inventory')}
                <span className="hidden sm:inline ml-1 truncate">Inventory</span>
              </TabsTrigger>
              <TabsTrigger value="financial" className="flex items-center justify-center py-3 px-1 text-xs lg:text-sm data-[state=active]:border-b-2 data-[state=active]:border-primary rounded-none min-w-0">
                {renderTabIcon('financial')}
                <span className="hidden sm:inline ml-1 truncate">Financial</span>
              </TabsTrigger>
              <TabsTrigger value="security" className="flex items-center justify-center py-3 px-1 text-xs lg:text-sm data-[state=active]:border-b-2 data-[state=active]:border-primary rounded-none min-w-0">
                {renderTabIcon('security')}
                <span className="hidden sm:inline ml-1 truncate">Security</span>
              </TabsTrigger>
              <TabsTrigger value="communication" className="flex items-center justify-center py-3 px-1 text-xs lg:text-sm data-[state=active]:border-b-2 data-[state=active]:border-primary rounded-none min-w-0">
                {renderTabIcon('communication')}
                <span className="hidden lg:inline ml-1 truncate">Comm</span>
              </TabsTrigger>
              <TabsTrigger value="backup" className="flex items-center justify-center py-3 px-1 text-xs lg:text-sm data-[state=active]:border-b-2 data-[state=active]:border-primary rounded-none min-w-0">
                {renderTabIcon('backup')}
                <span className="hidden lg:inline ml-1 truncate">Backup</span>
              </TabsTrigger>
              <TabsTrigger value="eta" className="flex items-center justify-center py-3 px-1 text-xs lg:text-sm data-[state=active]:border-b-2 data-[state=active]:border-primary rounded-none min-w-0">
                {renderTabIcon('eta')}
                <span className="hidden lg:inline ml-1 truncate">ETA</span>
              </TabsTrigger>
              <TabsTrigger value="quotation-preview" className="flex items-center justify-center py-3 px-1 text-xs lg:text-sm data-[state=active]:border-b-2 data-[state=active]:border-primary rounded-none min-w-0">
                {renderTabIcon('quotation-preview')}
                <span className="hidden lg:inline ml-1 truncate">Quote</span>
              </TabsTrigger>
              <TabsTrigger value="invoice-preview" className="flex items-center justify-center py-3 px-1 text-xs lg:text-sm data-[state=active]:border-b-2 data-[state=active]:border-primary rounded-none min-w-0">
                {renderTabIcon('invoice-preview')}
                <span className="hidden lg:inline ml-1 truncate">Invoice</span>
              </TabsTrigger>
              <TabsTrigger value="modules" className="flex items-center justify-center py-3 px-1 text-xs lg:text-sm data-[state=active]:border-b-2 data-[state=active]:border-primary rounded-none min-w-0">
                {renderTabIcon('modules')}
                <span className="hidden lg:inline ml-1 truncate">Modules</span>
              </TabsTrigger>
              <TabsTrigger value="order-status" className="flex items-center justify-center py-3 px-1 text-xs lg:text-sm data-[state=active]:border-b-2 data-[state=active]:border-primary rounded-none min-w-0">
