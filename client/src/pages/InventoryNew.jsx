    ...
    return (<div className="container mx-auto py-6 space-y-6">
      ...
      <Tabs defaultValue="inventory">
        ...
        <TabsContent value="inventory">
          <Card>
            ...
            <CardContent>
              <ProductFilter searchQuery={searchQuery} setSearchQuery={setSearchQuery} selectedStatus={selectedStatus} setSelectedStatus={setSelectedStatus} selectedCategory={selectedCategory} setSelectedCategory={setSelectedCategory} categories={categories}/>
              
              <InventoryTable products={filteredProducts} isLoading={isLoadingProducts} onEditProduct={handleEditProduct} onDeleteProduct={handleDeleteProduct} onCreateLabel={handleCreateLabel} calculateExpiryStatus={calculateExpiryStatus}/>
            </CardContent>
          </Card>
        </TabsContent>
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid gap-6">
                <CategoryTable categories={categories} isLoading={isLoadingCategories} onDeleteCategory={openDeleteDialog}/>
      ...
      <Dialog open={isProductFormOpen} onOpenChange={setIsProductFormOpen}>
        <DialogContent className="sm:max-w-[600px]">
          ...
          <ProductForm product={productToEdit} onSuccess={() => setIsProductFormOpen(false)}/>
        </DialogContent>
      </Dialog>
    </div>);
};
