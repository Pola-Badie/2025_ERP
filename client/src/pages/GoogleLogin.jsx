...
import { LogInIcon, UserIcon, ShieldIcon, CheckCircleIcon, AlertTriangleIcon, EyeIcon, EyeOffIcon, LoaderIcon } from 'lucide-react';
        ...
        <Card className="shadow-xl border-0">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-3">
              <Button onClick={() => handleGoogleLogin(true)} disabled={isLoading} className="w-full bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 hover:text-gray-900" variant="outline">
                {isLoading && authMethod === 'google' ? (<LoaderIcon className="w-4 h-4 mr-2 animate-spin"/>) : (<GoogleIcon />)}
                <span className="ml-2">Continue with Google</span>
              </Button>

              <Button onClick={() => handleGoogleLogin(false)} disabled={isLoading} variant="outline" className="w-full">
                <GoogleIcon />
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(handleTraditionalLogin)} className="space-y-4">
                ...
                <Button type="submit" className="w-full" disabled={isLoading}>
                  {isLoading && authMethod === 'traditional' ? (<LoaderIcon className="w-4 h-4 mr-2 animate-spin"/>) : (<LogInIcon className="w-4 h-4 mr-2"/>)}
                  Sign In
                </Button>
              </form>
            </Form>
