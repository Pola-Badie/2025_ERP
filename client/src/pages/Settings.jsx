...
const Settings = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        updateBackupSettings.mutate(formSettings);
    };
    // Handle form changes
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <div className="space-y-4">
                        <div className="flex items-center justify-between p-3 border rounded-lg">
                          ...
                          <Switch checked={formSettings.dailyBackup} onCheckedChange={(value) => handleChange('dailyBackup', value)}/>
                        </div>
                        ...
                        <div className="flex items-center justify-between p-3 border rounded-lg">
                          ...
                          <Switch checked={formSettings.weeklyBackup} onCheckedChange={(value) => handleChange('weeklyBackup', value)}/>
                        </div>
                        ...
                        <div className="flex items-center justify-between p-3 border rounded-lg">
                          ...
                          <Switch checked={formSettings.monthlyBackup} onCheckedChange={(value) => handleChange('monthlyBackup', value)}/>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <Select value={formSettings.backupTime} onValueChange={(value) => handleChange('backupTime', value)}>
                          <SelectTrigger>
                      ...
                      <div>
                        ...
                        <Select value={formSettings.retentionDays?.toString()} onValueChange={(value) => handleChange('retentionDays', parseInt(value))}>
                          <SelectTrigger>
