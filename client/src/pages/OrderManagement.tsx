        ...
        <TabsContent value="refining">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-md shadow-sm p-6 border">
              ...
              <div className="mb-6">
                <h3 className="text-lg font-semibold mb-4">Cost and Transportation</h3>
                ...
                <div className="grid gap-4">
                  ...
                  <div className="bg-muted p-4 rounded-md">
                    <div className="flex justify-between items-center">
                      <span className="font-medium">Total Cost (with tax):</span>
                      <span className="text-xl font-bold">${refiningCost}</span>
                    </div>
                  </div>
                </div>
              </div>
