...
import { insertBatchSchema, insertProductFormulationSchema, insertProductSafetySchema, insertQualityTestSchema, insertProductionOrderSchema, insertRegulatorySubmissionSchema, insertWarehouseSchema, insertWarehouseLocationSchema, insertAccountSchema, insertJournalEntrySchema, insertJournalLineSchema, insertCustomerPaymentSchema, insertPaymentAllocationSchema, insertTaxRateSchema, insertCurrencySchema, insertBankAccountSchema, insertBudgetSchema, insertAssetSchema, insertDepartmentSchema, insertEmployeeProfileSchema, insertDocumentSchema, insertNotificationSchema } from "@shared/schema";
const router = Router();
...
router.get("/quality-tests", async (req, res) => {
    try {
        const batchId = req.query.batchId ? parseInt(req.query.batchId) : undefined;
