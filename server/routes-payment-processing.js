import { db } from "./db";
import { customerPayments, paymentAllocations, sales, customers, journalEntries, journalEntryLines, accounts, } from "@shared/schema";
import { eq, sql, desc } from "drizzle-orm";
export function registerPaymentProcessingRoutes(app) {
...
async function createPaymentAccountingEntries(payment, customerId, amount) {
    try {
        // Get customer name
...
async function updateAccountBalances(accountId, amount, type) {
