import { db } from "./db";
import { accounts, sales, expenses, customers } from "@shared/schema";
    ...
    try {
        ...
        for (const invoice of financialData.dueInvoices.slice(0, 10)) {
            ...
            if (!exists) {
                ...
                const customer = customersResult.find(c => c.name.toLowerCase().includes(invoice.client.toLowerCase()) ||
